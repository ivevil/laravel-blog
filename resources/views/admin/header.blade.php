...
<body>
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
      <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="{{ route('index') }}" target="_blank">{{$settings->website_name}}</a>
        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <li class="nav-item d-flex">
                <a class="nav-link @if(Route::current()->getName() == 'posts') active @endif" href="{{route('posts')}}">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file"><path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"></path><polyline points="13 2 13 9 20 9"></polyline></svg>
                  Posts
                </a>
              </li>
              <li class="nav-item d-flex">
                <a class="nav-link @if(Route::current()->getName() == 'categories') active @endif" href="{{route('categories')}}">
              ...
              <li class="nav-item">
                <a class="nav-link @if(Route::current()->getName() == 'media') active @endif" href="{{route('media')}}">
            ...
            <li class="nav-item">
                <a class="nav-link @if(Route::current()->getName() == 'widgets') active @endif" href="{{route('widgets')}}">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-zap"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>
                  Widgets
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link @if(Route::current()->getName() == 'menus') active @endif" href="{{route('menus')}}">
               ...
               <li class="nav-item">
                <a class="nav-link @if(Route::current()->getName() == 'pages') active @endif" href="{{route('pages')}}">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-layers"><polygon points="12 2 2 7 12 12 22 7 12 2"></polygon><polyline points="2 17 12 22 22 17"></polyline><polyline points="2 12 12 17 22 12"></polyline></svg>
                  Pages
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link @if(Route::current()->getName() == 'users') active @endif" href="{{route('users')}}">
